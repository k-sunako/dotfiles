...
* Shell / 環境
  ...
  #+BEGIN_SRC emacs-lisp
    ...
    (use-package vterm
      ...
      :hook (vterm-mode . (lambda () (vterm--exclude-keys vterm-mode-map vterm-keymap-exceptions))))
  #+END_SRC
...
#+begin_src emacs-lisp
  ...
  (use-package khoj
    ...
    (setq khoj-index-directories '("~/myspace/org-roam" "~/projects" "~/myspace/Bibliography") )
