  ...
  #+BEGIN_SRC emacs-lisp
    ...
    (use-package org-ref
      ...
      (setq bibtex-completion-display-formats
            '((article       . "${author:6} ${title:30} ${journal:40} ${year:4} ${=has-pdf=:1}${=has-note=:1} ${=type=:3}")
              (inbook        . "${author:6} ${title:30} ${year:4} ${=has-pdf=:1}${=has-note=:1} ${=type=:3}")
              (book          . "${author:6} ${title:30} ${year:4} ${=has-pdf=:1}${=has-note=:1} ${=type=:3}")
              (t             . "${author:6} ${title:30} ${year:4} ${=has-pdf=:1}${=has-note=:1} ${=type=:3}"))))
