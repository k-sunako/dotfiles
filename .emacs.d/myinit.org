...
* Shell / 環境
  ...
  #+BEGIN_SRC emacs-lisp
    ...
    (use-package vterm
      ...
      ;(define-key vterm-mode-map (kbd "<DEL>") (lambda () (interactive) (vterm-send-key "DEL")))
...
#+begin_src emacs-lisp
  (use-package aidermacs
    ...
    (setq aidermacs-args '("–model" "gpt-4o-mini" "–chat-history-file" "~/myspace/aider-logs/history.md")) 
    (global-set-key (kbd "C-c a") 'aidermacs-transient-menu)

    ;; UIバックエンドを vterm に指定
    (setq aidermacs-backend 'vterm)
    ;; vterm利用時のウィンドウ設定（必要に応じて）
    ;; Aiderを画面下部にポップアップさせるなどの挙動を安定させます
    (add-to-list 'display-buffer-alist
                 '("\\*aidermacs-vterm\\*"
...
#+begin_src emacs-lisp
  (use-package org-ai
    :if (file-exists-p "~/myspace/dotfiles-secret/openai.el")
    :straight
    (:type git :host github :repo "rksm/org-ai"
           :local-repo "org-ai"
...
#+begin_src emacs-lisp
  ...
  (use-package khoj
    ...
    (setq khoj-index-directories '("~/myspace/org-roam"
                                   ...
                                   "~/myspace/Lecture/Math/高瀬数学塾/texts/"
                                   "~/myspace/Lecture/Math/機械学習セミナー/texts/") )
    :config
...
#+BEGIN_SRC emacs-lisp
  ...
  (defun ks-anki-editor-push-notes ()
    (interactive)
    (ignore-errors
      (unwind-protect
          (progn
        ...
        (advice-remove #'org-html--format-image #'org-org-html--format-image))))
